...
url_muni <- paste0(
    "https://resultados.tse.jus.br/oficial/ele2022/544/dados/", str_to_lower(muni_tse$uf),
...
write_excel_csv2(final, "sp_presidente_validos_municipio.csv")
...
nao_validos <- municipios %>%
 ...
 write_excel_csv2(nao_validos, "sp_presidente_nao_validos_municipio.csv")
